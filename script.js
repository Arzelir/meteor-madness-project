...
// ----------------------------
const asteroids = [
  { spk: '99942', name: 'Apophis', diameter: 370, velocity: 7.4, density: 3000 },
  { spk: '2000433', name: 'Eros', diameter: 34400, velocity: 5.9, density: 2700 },
  { spk: '101955', name: 'Bennu', diameter: 492, velocity: 12, density: 1200 },
  { spk: '25143', name: 'Itokawa', diameter: 535, velocity: 6.1, density: 1900 },
  { spk: '162173', name: 'Ryugu', diameter: 900, velocity: 5.0, density: 1300 },
  { spk: '243', name: 'Ida', diameter: 15000, velocity: 5.3, density: 2600 },
  { spk: '3122', name: 'Florence', diameter: 4400, velocity: 13.3, density: 2700 },
  { spk: '52768', name: '1998 OR2', diameter: 2800, velocity: 7.1, density: 2500 }
];
...
document.getElementById("simulateBtn").addEventListener("click", () => {
  ...
  let lat = impactLatLng ? impactLatLng.lat : parseFloat(document.getElementById("lat").value);
  let lng = impactLatLng ? impactLatLng.lng : parseFloat(document.getElementById("lng").value);
  ...
  if (selectedAsteroid) {
    ...
    if (isNaN(mass) || isNaN(velocity)) return alert("Please enter valid mass and velocity!");
  }
